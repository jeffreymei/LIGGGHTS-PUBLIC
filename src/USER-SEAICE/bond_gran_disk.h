...
BondStyle(gran/disk,BondGranDisk)

#else

#ifndef LMP_BOND_GRAN_DISK_H
#define LMP_BOND_GRAN_DISK_H
...
class BondGranDisk : public Bond {
 public:
  BondGranDisk(class LAMMPS *);
  ~BondGranDisk();
  void init_style();
