...
AtomStyle(disk/waves,AtomVecDiskWaves)

#else

#ifndef LMP_ATOM_VEC_DISK_WAVES_H
#define LMP_ATOM_VEC_DISK_WAVES_H

#include "atom_vec.h"

namespace LAMMPS_NS {

class AtomVecDiskWaves : public AtomVec {
 public:
  AtomVecDiskWaves(class LAMMPS *);
  ~AtomVecDiskWaves() {}
  void init();
  void grow(int);
  void grow_reset();
